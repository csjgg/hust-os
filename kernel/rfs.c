...
struct vinode *rfs_create(struct vinode *parent, struct dentry *sub_dentry) {
  ...
  // (free_dinode) of a new file being created. hint:  members of free_dinode to
  // be filled are: size, should be zero for a new file. type, see kernel/rfs.h
  // and find the type for a rfs file. nlinks, i.e., the number of links.
